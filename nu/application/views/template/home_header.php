                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="nav navbar-nav navbar-right navbar-right-no-mar"> 
                        	<li> <?php echo anchor('profile','<i class="fa fa-user"></i> My Profile');?></li>
                        	<li> <?php echo anchor('orders','&nbsp;&nbsp;<i class="fa fa-shopping-cart"></i> My Orders');?>
                            <li> <?php echo anchor('profile/change_password','&nbsp;&nbsp;<i class="fa fa-lock"></i> Change Password');?>
                            <li><?php echo anchor('buyer_home/logout','&nbsp;&nbsp;<i class="fa fa-sign-out"></i> Logout'); ?>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <nav class="navbar navbar-default navbar-main navbar-pad-top navbar-first">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <?php echo anchor('buyer_home','<img src="http://nucatalog.com/nu/img/logo-w.png" title="Home" />','class="navbar-brand"');?>
                </div>
                <div class="rel">
                ...
                <ul class="nav navbar-nav navbar-right navbar-mob-item-left">
                    ...
                    <li class="dropdown"><a class="header-checkout" href="#"><i class="fa fa-heart"></i> <sup><?php echo $list_count;?></sup></a>
