...
<!-- Main navbar -->
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href=""><img src="<?php echo base_url();?>img/logo-w.png" alt=""></a>
...
<!-- Main navbar -->
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<?php echo anchor('vendor_home','<img src="'.base_url().'img/logo-w.png" alt="NuCatalog">','class="navbar-brand"'); ?>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						...
						<span style="color:#000;"><?php echo $vendor_name;?></span>
	...
	<!-- Second navbar -->
	<div class="navbar navbar-default" id="navbar-second" hidden>
