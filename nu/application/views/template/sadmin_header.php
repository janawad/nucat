...
<!-- Main navbar -->
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<?php echo anchor('sadmin_home','<img src="http://nucatalog.com/nu/img/logo-w.png" alt="NuCatalog">','class="navbar-brand"'); ?>
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<p class="navbar-text"><span class="label bg-success-400">ADMIN PANEL</span></p>
