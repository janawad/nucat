...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<link href="<?php echo base_url();?>public/assets/admin/pages/css/lock.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/js/pages/animations_css3.js"></script>
	<!-- END THEME STYLES -->
...
<!-- BEGIN BODY -->
<body class="page-md" style=" background-color: #F4F8F9;">
 <br />
