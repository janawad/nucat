			...
			<?php echo form_open('verifylogin/vendor'); ?>
				<div class="panel panel-body login-form">
					...
					<div class="form-group has-feedback has-feedback-left">
						...
						<?php echo form_error('email','<div class="text-warning">','</div>');?>
					</div>
					...
					<div class="form-group has-feedback has-feedback-left">
						...
						<?=anchor('buyer/forgot_pwd1','Forgot Password..?');?>
						<!-- <a href="#">Forgot password?</a> -->
						<?php echo form_error('password','<div class="text-warning">','</div>');?>
					</div>
				...
				<div class="panel panel-body login-form">
					...
					<div class="form-group has-feedback has-feedback-left">
						...
						<div class="form-control-feedback">
							...
							<?php echo form_error('email1','<div class="text-warning">','</div>');?>
					</div>
					...
					<div class="form-group has-feedback has-feedback-left">
						...
						<?=anchor('buyer/forgot_pwd','Forgot Password..?');?>
						<?php echo form_error('password1','<div class="text-warning">','</div>');?>
					</div>
