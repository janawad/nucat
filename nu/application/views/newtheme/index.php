...
<head>
    ...
    <!--====== MAIN STYLESHEET ======-->
    <link href="<?php echo base_url(); ?>nstyle.css" rel="stylesheet">
                                ...
                                <ul>
                                    ...
                                    <li class="checkout"><a class="header-checkout" href="#"><i class="fa fa-cart-plus"></i><sup>10</sup></a>
                                        <ul class="shopping-cart-down box-shadow white-bg">
                                            <li class="media">
                                                <a href="#"><img alt="" src="<?php echo base_url(); ?>nimages/cart/1.jpg"></a>
                                            ...
                                            <li class="media">
                                                <a href="#"><img alt="" src="<?php echo base_url(); ?>nimages/cart/2.jpg"></a>
                                            ...
                                            <li class="media">
                                                <a href="#"><img alt="" src="<?php echo base_url(); ?>nimages/cart/3.jpg"></a>
                    ...
                    <div class="row ppo-product grid">
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 men mix">
                            <div class="single-popular-product">
                                <div class="populer-product-photo"> <img src="<?php echo base_url(); ?>nimages/pro-1.png" alt="popular">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 kids women mix">
                            <div class="single-popular-product">
                                <div class="populer-product-photo"> <img src="<?php echo base_url(); ?>nimages/pro-6.png" alt="popular">
                                    <div class="add-cart"> <a href="#"><i class="fa fa-heart-o"></i></a> <a href="#">Add to cart</a> <a href="#"><i class="fa fa-random"></i></a> </div>
                                </div>
                                <h5>Night Dress</h5> <span class="rate">&#36;120</span> </div>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 women mix">
                            <div class="single-popular-product">
                                <div class="populer-product-photo"> <img src="<?php echo base_url(); ?>nimages/pro-7.png" alt="popular">
                                    <div class="add-cart"> <a href="#"><i class="fa fa-heart-o"></i></a> <a href="#">Add to cart</a> <a href="#"><i class="fa fa-random"></i></a> </div>
                                </div>
                                <h5>Night Dress</h5> <span class="rate">&#36;120</span> </div>
                        </div>
