                 ...
                 <a href="#"><i class="fa fa-envelope fa-1x">&nbsp;info@nucatalog.com</i> </a>							
                        ...
                        <div class="col-xs-6 col-sm-8 text-right">
                            <div class="header-contact">
                                <ul>
                                    <li class="hidden-xs"><a href="<?php echo base_url(); ?>profile"><i class="fa fa-user"></i>My Profile</a></li>
									<li class="hidden-xs"><a href="<?php echo base_url(); ?>orders"><i class="fa fa-user"></i>My orders</a></li>
