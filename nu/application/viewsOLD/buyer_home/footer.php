                ...
                <div class="row wow fadeIn">
                    <div class="col-xs-12 col-sm-3">
                        <div class="single-footer">
							...
							<a href="<?php echo base_url(); ?>buyer_home/aboutUs" class="btn btn-default">View More</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-2">
                        <div class="single-footer">
                            ...
                            <ul>
                                ...
                                <li><a href="<?php echo base_url(); ?>">Buyer Login</a></li>
                                <li><a href="<?php echo base_url(); ?>">Vender Login</a></li>
                    ...
                    <div class="col-xs-6 col-sm-2">
                        <div class="single-footer">
                            ...
                            <ul>
								...
								<li><a href="<?=base_url('pdf/tc.pdf')?>" target="_blank">Term's & Policy</a></li>
